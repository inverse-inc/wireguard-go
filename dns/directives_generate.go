...
func main() {
	...
	genImports("dns/core/plugin/zplugin.go", "plugin", mi)
	genDirectives("dns/core/dnsserver/zdirectives.go", "dnsserver", md)
}
...
const (
	pluginPath   = "github.com/inverse-inc/wireguard-go/dns/plugin/"
	pluginFile   = "dns/plugin.cfg"
	pluginFSPath = "dns/plugin/" // Where the plugins are located on the file system
